...
- [Download the dataset
  now](https://media.githubusercontent.com/media/CUNY-epibios/PUBH614/main/datasets/nycflights.csv)
...
This dataset contains information about all flights that departed from
NYC in 2013. The dataset includes 500 observations with 16 variables.
...
- **Type**: Categorical
- **Values**: Various 3-letter destination codes, e.g. ABQ, ACK, ALB,
  etc.
- **Missing values**: 0
...
- `tailnum` omitted for brevity as it contains 3,490 unique values (one
  for each individual airplane).
...
- Although `flight` is coded as numeric, it should be considered as a
