...
- [Download the dataset
  now](https://media.githubusercontent.com/media/CUNY-epibios/PUBH614/main/datasets/yrbss.csv)
...
This dataset contains information from the Youth Risk Behavior
Surveillance System (YRBSS), including demographic details, health
behaviors, and other related information. The dataset includes 13,583
observations with 13 variables. The `openintro` package also provides a
sample of `n=100` from this dataset titled `yrbss_samp`.
...
- **Type**: Categorical
- **Values**: Various race categories (e.g., Black or African American,
  White, Asian, etc.)
...
- **Type**: Categorical
- **Values**: never, rarely, sometimes, most of time, always, did not
  ride
- **Missing values**: 311

#### text_while_driving_30d

- **Description**: Frequency of texting while driving in the past 30
  days
- **Type**: Categorical
...
- **Description**: Number of days doing strength training in the past 7
  days
- **Type**: Numeric
- **Values**: Range from 0 to 7 days
...
- Some inherently numeric data are coded as character with bins. Some
  analyses may benefit from recoding as ordered factor or numeric.
  - `text_while_driving_30d`
  - `hours_tv_per_school_day`
  - `school_night_hours_sleep`
