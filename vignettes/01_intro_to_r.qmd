...
Fill out for printing and handing in. Note that there is no "save" feature, 
so please test printing the page as a PDF, and keep a record of your code and text,
...
If you are viewing this lab on [https://cuny-epibios.github.io/PUBH614/](https://cuny-epibios.github.io/PUBH614/), you can 
...
tidyverse library, which provides data manipulation and plotting functions that 
