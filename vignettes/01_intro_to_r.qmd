...
#| exercise: ex_1
#| check: true
if (identical(.result, arbuthnot$girls)) {
...
What symbols are used to extract columns from a `data.frame`?
What is the name of the variable you are trying to extract?
