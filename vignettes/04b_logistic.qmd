...
For this lab we load an external dataset.  When working with files in R, it's important to 
know what your working directory is, and where the file that you want to load is.
...
Instead, this lab uses webR/WASM, which is isolated from your computer's filesystem
...
Since the webR/WASM filesystem is isolated from your local filesystem, we'll use `download.file()` to download the dataset from the web. For another dataset, you
could use Dropbox etc to create a downloadable URL for a file you want to use.

Datasets for PUBH614 labs are kept at https://github.com/CUNY-epibios/PUBH614/tree/main/datasets.
...
it is https://raw.githubusercontent.com/CUNY-epibios/PUBH614/refs/heads/main/datasets/Stats4-%20more.csv.

The `destfile` argument specifies what filename to use for the downloaded file.

```{webr-r}
url = "https://raw.githubusercontent.com/CUNY-epibios/PUBH614/refs/heads/main/datasets/Stats4-%20more.csv"
download.file(url = "https://raw.githubusercontent.com/CUNY-epibios/PUBH614/refs/heads/main/datasets/Stats4-%20more.csv", 
